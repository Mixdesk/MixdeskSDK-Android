...
public class MXWarpLinearLayout extends ViewGroup {

    public MXWarpLinearLayout(Context context) {
        super(context);
    }

    public MXWarpLinearLayout(Context context, AttributeSet attrs) {
        this(context,attrs,0);
    }

    public MXWarpLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
