package com.mixdesk.mixdesksdk.pw;
 ...
 * 描述:图片选择界面中的图片目录选择窗口
 */
public class MXPhotoFolderPw extends MXBasePopupWindow implements AdapterView.OnItemClickListener {
    ...
    public MXPhotoFolderPw(Activity activity, View anchorView, Callback callback) {
        super(activity, R.layout.mx_pw_photo_folder, anchorView, WindowManager.LayoutParams.MATCH_PARENT, WindowManager.LayoutParams.MATCH_PARENT);
        mCallback = callback;
    }
    ...
    private class FolderAdapter extends BaseAdapter {
        ...
        public FolderAdapter() {
            ...
            mImageWidth = MXUtils.getScreenWidth(mActivity) / 10;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.mx_item_photo_folder, parent, false);
            ...
            MXImage.displayImage(mActivity, folderViewHolder.photoIv, imageFolderModel.coverPath, R.drawable.mx_ic_holder_light, R.drawable.mx_ic_holder_light, mImageWidth, mImageHeight, null);
