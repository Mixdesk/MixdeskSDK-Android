 ...
 * 描述:
 */
public class MXLoadPhotoTask extends MXAsyncTask<Void, ArrayList<ImageFolderModel>> {
    private final Context mContext;
    private final boolean mTakePhotoEnabled;

    public MXLoadPhotoTask(Callback<ArrayList<ImageFolderModel>> callback, Context context, boolean takePhotoEnabled) {
        super(callback);
    ...
    public MXLoadPhotoTask perform() {
