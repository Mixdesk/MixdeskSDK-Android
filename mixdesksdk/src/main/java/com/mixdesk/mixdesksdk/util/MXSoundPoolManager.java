...
public class MXSoundPoolManager {
    ...
    public static MXSoundPoolManager getInstance(Context context) {
        return new MXSoundPoolManager(context.getApplicationContext());
    }

    private MXSoundPoolManager(Context context) {
