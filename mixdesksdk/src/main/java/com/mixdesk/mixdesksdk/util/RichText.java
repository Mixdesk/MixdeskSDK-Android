...
public class RichText {
    ...
    public RichText() {
        imageGetter = new Html.ImageGetter() {
            ...
            public Drawable getDrawable(final String source) {
                ...
                Drawable drawableFromFile = MXUtils.getDrawableFromFile(textView.getContext(), source);
                ...
                MXImage.downloadImage(textView.getContext(), source, new MXImageLoader.MQDownloadImageListener() {
                    @Override
                    public void onSuccess(String url, final Bitmap bitmap) {
                        ...
                        new Thread(new Runnable() {
                            @Override
                            public void run() {
                                MXUtils.saveBitmap(textView.getContext(), source, bitmap);
                            }
                        }).start();
                    }
    ...
    private void resizeDrawable(Drawable drawable) {
        ...
        // 气泡最大宽度为 240 dp
        int limitWidth = MXUtils.dip2px(textView.getContext(), 205);
        if (right > limitWidth) {
